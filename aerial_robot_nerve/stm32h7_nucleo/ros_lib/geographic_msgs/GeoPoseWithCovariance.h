#ifndef _ROS_geographic_msgs_GeoPoseWithCovariance_h
#define _ROS_geographic_msgs_GeoPoseWithCovariance_h
...
namespace geographic_msgs
{
  ...
  class GeoPoseWithCovariance : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "geographic_msgs/GeoPoseWithCovariance"; };
    virtual const char * getMD5() override { return "84c133e7220362d3d8aff8e415075357"; };
