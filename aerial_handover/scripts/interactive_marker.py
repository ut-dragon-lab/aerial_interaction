...
class SingleMarkerBroadcaster:
    def __init__(self):
        ...
        self.pose_pub = rospy.Publisher('/desired_3D_pose', PoseStamped, queue_size=1)
    ...
    def update_pose_callback(self, feedback):
        if feedback.event_type == InteractiveMarkerFeedback.POSE_UPDATE:
            ...
            rospy.loginfo("Quat R: %f, P: %f, Y: %f",
                          roll, pitch, yaw)
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(" InteractiveMarker Init Failed ! ")
        pass
